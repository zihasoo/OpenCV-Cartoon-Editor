...
1. 사람 얼굴은 블러를 사용하고 외곽선을 강조해도 카툰 느낌을 만드는 것이 어렵습니다.
2. 설정값을 아무리 조정해도 카툰 스타일을 유지하면서 불필요한 노이즈를 없앨 수 없었습니다.

호랑이 사진의 경우, 카툰 느낌으로 랜더링이 잘 되었고, 노이즈도 심하지 않았습니다. 하지만 카리나 사진의 경우 이상한 노이즈가 너무 많이 생겼고 얼굴의 음영이 과도하게 강조돼 카툰이 아니라 다른 화풍 느낌이 됐습니다.

음영이 강조되지 않으면서 외곽선은 살릴 방법이 있다면 결과가 더 나아질 것이라 생각합니다.